              ...
              <div>
                <nav id="gap" className="flex flex-warp mt-4  text-l text-blue-700 mb-15">
                  <div className="flex flex-col md:w-1/3 md:mb-0 md:mx-40">
                    <Link className="hover:opacity-75 mb-4" to="/">
                      Home
                    </Link>
                    <Link className="hover:opacity-75 mb-4" to="/Categores">
                      Services
                    </Link>
                  ...
                  <div id="gap_2" className="flex flex-col md:w-1/3 md:mb-0 md:ml-60">
                    <Link className="hover:opacity-75 mb-4" to="/ContactUs">
                      Contact
                    </Link>
                    <Link className="hover:opacity-75 mb-4" to="/WhyUs">
                      WhyUs
                    </Link>
