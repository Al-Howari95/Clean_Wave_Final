...
const Categories = () => {
  ...
  useEffect(() => {
    ...
    setAuthToken(Token);
    axios
      .get("http://127.0.0.1:3001/secondpage/category/16")
      .then((response) => {
  ...
  const handleSearch = () => {
    axios
      .get("http://127.0.0.1:3001/secondpage/getallproducts")
      .then((response) => {
    ...
    <div className="flex flex-col items-center">
      <div>
        ...
        <button
          ...
          className="bg-blue-500 text-white p-2 rounded-lg mb-4 ml-2"
        >
          Search
        </button>
